...
Given two stringsa andb consisting of lowercase characters.
...
public:
    bool isAnagram(string a, string b)
    {
        ...
        // Maintain the frequency of characters in both the strings
        ...
        // Now check if the frequency of a character is not equal in both the
        // strings so it's not the Anagram and return false;
        for (int i = 0; i < 256; i++)
        {
            if (s1[i] != s2[i])
            {
